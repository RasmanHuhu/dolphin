...
public class HibernateConfig {
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        // add annotated classes - fortæl Hibernate hvilke Entity klasser vi har
        //configuration.addAnnotatedClass(_class_.class);
        //GØr Hibernate opmærksom på at disse hører med i JPA
        configuration.addAnnotatedClass(Person.class);
        configuration.addAnnotatedClass(PersonDetail.class);
        configuration.addAnnotatedClass(Fee.class);
    }

    public static EntityManagerFactory getEntityManagerFactoryConfig(String dolphin) {
